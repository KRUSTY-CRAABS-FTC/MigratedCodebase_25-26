...
public class redFrontAuto extends LinearOpMode {
    ...
    // --- Constants ---
    private static final double SERVO_STOP = 0.53;
    private static final double SERVO_FORWARD = 1.0;
    private static final double GECKO_POWER = 0.55;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // 0️⃣ Move forward 6 feet (72 inches)
        ...
        // 3️⃣ Turn left 140 degrees (mirrored from blue)
        telemetry.addLine("Turning Left 140°...");
        telemetry.update();
        // Assuming positive = left, use +140 for left turn
        robot.turn(140, 0.5);
        waitUntilDriveComplete();
