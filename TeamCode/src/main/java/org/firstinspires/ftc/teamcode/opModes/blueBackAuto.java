...
public class blueBackAuto extends LinearOpMode {
    ...
    private static final double GECKO_POWER = 0.60; // updated as requested
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.update();
        runFullShootSequence(GECKO_POWER, INTAKE_POWER, 6000);

        telemetry.addLine("Moving left 2ft...");
        telemetry.update();
        robot.strafe("right", (int)(24 * Mechanisms.TICKS_PER_INCH), 0.5);
    ...
    /** Start intake + both servos forward */
